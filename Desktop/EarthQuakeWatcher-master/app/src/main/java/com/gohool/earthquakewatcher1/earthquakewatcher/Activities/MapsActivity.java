...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showListBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { startActivity(new Intent(MapsActivity.this, QuakesListActivity.class));
            }
        });
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.URL,null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        DatabaseReference db = database.getReference("quakes");
                        try {
                            ...
                            for (int i = 0; i < Constants.LIMIT; i++) {
                                ...
                                db.child(earthQuake.getPlace()).setValue(earthQuake);
                            }
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("quakes");
                db.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for(DataSnapshot pSnapshot : dataSnapshot.getChildren()) {
                            EarthQuake earthQuake = pSnapshot.getValue(EarthQuake.class);
                            java.text.DateFormat dateFormat = java.text.DateFormat.getDateInstance();
                            String formattedDate =  dateFormat.format(new Date(Long.valueOf(earthQuake.getTime())).getTime());
